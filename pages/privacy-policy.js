    ...
    <>
      ...
      <main className='fix container custom-container-one '>
        ...
        <p className='mb-100'>
          ...
          Оператор может получить о посетителях веб-сайта https://fastmthai.pro.
          <br />
          ...
          сети интернет по сетевому адресу https://fastmthai.pro.
          <br />
          ...
          посетитель веб-сайта https://fastmthai.pro.
          <br />
          ...
          данныеномера телефонов Правовые основанияФедеральный закон «Об
          информации, информационных технологиях и о защите информации» от
          27.07.2006 N 149-ФЗ Виды обработки персональных данныхПередача
          персональных данных <br />
          ...
          законом. 8. Порядок сбора, хранения, передачи и других видов обработки
          ...
          fastmanij@gmail.com с пометкой «Актуализация персональных данных».{' '}
          <br />
          ...
          на электронный адрес Оператора fastmanij@gmail.com с пометкой «Отзыв
          ...
          Оператору с помощью электронной почты fastmanij@gmail.com. <br />
          ...
          сети Интернет по адресу https://fastmthai.pro.
        </p>
      </main>
      <FooterOne />
    </>
